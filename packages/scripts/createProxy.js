...
if (process.argv.length !== 3) {
    console.log("ts-node createProxy.ts <target-address>");
    process.exit(1);
}
var targetAddress = process.argv[2];
// Builds DAC Proxy And enters the compound market
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var dacProxyFactoryContract, cTokensToEnter;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, index_1.dedgeHelpers.proxyFactory.buildAndEnterMarketsOwner(targetAddress, dacProxyFactoryContract, DeployedAddresses_json_1.dedgeCompoundManagerAddress, cTokensToEnter)];
            case 1:
                _a.sent();
