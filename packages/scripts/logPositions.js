...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, helpers_1.dedgeHelpers.compound.getCTokenBorrowBalance(common_1.wallet, legos.compound.cWBTC.address, addr)];
            case 1:
                amount = _a.sent();
                console.log("Borrowed WBTC: " + ethers_1.ethers.utils.formatUnits(amount.toString(), 8));
                return [2 /*return*/];
        }
    });
}); };
